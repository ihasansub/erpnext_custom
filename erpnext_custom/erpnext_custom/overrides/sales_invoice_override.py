...
from erpnext.accounts.party import get_due_date, get_party_account, get_s
...
class SalesInvoiceCustom(SellingController):
	...
	def add_remarks(self):
		...
		if not self.remarks:
			for item in self.get("items"):
                remark = str(remark) + " " + str(item.note)
            self.remarks = str(remark)
